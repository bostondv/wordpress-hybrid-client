...
mod.run(($templateCache) => {
    ...
    $templateCache.put('module/params/pushNotifications.html', require('!html!./module/params-pushNotifications.html'));
    ...
    $templateCache.put('module/auth/auth.html', require('!html!./module/auth.html'));
    $templateCache.put('module/auth/login.html', require('!html!./module/auth-login.html'));
    $templateCache.put('module/auth/register.html', require('!html!./module/auth-register.html'));
    $templateCache.put('module/auth/unauth.html', require('!html!./module/auth-unauth.html'));
    $templateCache.put('module/compose.html', require('!html!./module/compose.html'));
